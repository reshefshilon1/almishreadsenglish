...
export const WORD_LEVELS: Record<number, WordEntry[]> = {
  ...
  3: [
    ...
    { word: "then", emoji: "⏭️", distractors: ["den", "hen", "ten"] },
  ...
  4: [
    ...
    { word: "moon", emoji: "🌙",  distractors: ["noon", "soon", "loot"] },
...
export const WORD_LEVEL_INFO = [
  ...
  { level: 4, label: "Vowel Clusters", description: "ee, ea, oo, ie, au", count: 13, color: "bg-game-orange" },
];
